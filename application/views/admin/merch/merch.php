...
<section class="panel">
	<header class="panel-heading">
		<div class="panel-actions">
			<a href="<?php echo site_url('merch/Add');?>">
				<button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i>Tambah Merch</button>
			</a>
		</div>
	...
	<div class="panel-body">
		<div class="table-responsive">
			<table class="table table-bordered table-striped mb-none" id="tbl_merch">
				<thead>
					<tr>
						<th>Deskripsi</th>
						<th>Foto</th>
						...
						foreach($Merch as $item){
							echo "
								<tr class='gradeU'>
									...
									<td><img src='".base_url()."temp/merch/".$item->foto."' width='20%'></td>
									<td>
										<a href='".site_url('Merch/Edit/'.$item->id_merch)."'>
											<button type='button' class='btn btn-warning'><i class='glyphicon glyphicon-edit'></i> Ubah</button>
										</a>
										<a href='javascript:void(0);' class='item_delete modal-basic' data-id='".$item->id_merch."'>
		...
		<div class="modal fade" id="Modal_Delete" tabindex="-1" role="dialog" aria-hidden="true">
	      	<div class="modal-dialog" role="document">
	        	<div class="modal-content">
		            ...
		            <h5 class="modal-title" id="exampleModalLabel">Hapus Merch</h5>
...
<script type="text/javascript">
	...
	$('#btn_delete').on('click',function(){
	    ...
	    $.ajax({
	        type : "POST",
	        data: "id="+id,
	        url: "<?php echo site_url("merch/Hapus");?>",
