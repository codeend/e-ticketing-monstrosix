...
<header class="page-header">
	...
	<div class="right-wrapper pull-right">
		<ol class="breadcrumbs">
			...
			<li><span>Tambah Rekening</span></li>
		</ol>
		&nbsp;
	</div>
</header>
...
<section class="panel">
	...
	<div class="panel-body">
		<form class="form-horizontal form-bordered" method="post" enctype="multipart/form-data" action="<?php echo site_url('Rekening/AddProses');?>">
			<div class="form-group">
				<label class="col-md-3 control-label" for="inputDefault">Nama Bank</label>
				<div class="col-md-6">
					<input type="text" class="form-control" id="inputDefault" name="nama_bank" placeholder="Nama Bank">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<input type="text" class="form-control" id="inputDefault" name="atas_nama" placeholder="Atas Nama">
				</div>
			</div>
