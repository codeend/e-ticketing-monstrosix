...
<section class="panel">
	<header class="panel-heading">
		<div class="panel-actions">
			<a href="<?php echo site_url('Pengguna/Add');?>">
				<button type="button" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah Pengguna</button>
			</a>
		</div>
	...
	<div class="panel-body">
		<div class="table-responsive">
			<table class="table table-bordered table-striped mb-none" id="tbl_pengguna">
				<thead>
					<tr>
						<th>Nama Pengguna</th>
						<th>No Telp</th>
							...
							echo "
								<tr class='gradeU'>
									...
									<td>
										...
										<a href='javascript:void(0);' class='item_delete modal-basic' data-id='".$item->id_pengguna."'>
